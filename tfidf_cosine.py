...
def train_model():
    ...
    joblib.dump((tfidf, tfidf_matrix), "models/tfidf_cosine.pkl")

def get_similar_movies(movie_id: int, top_n: int = 10):
    tfidf, tfidf_matrix = joblib.load("models/tfidf_cosine.pkl")
    ...
    cosine_similarities = cosine_similarity(movie_vector, tfidf_matrix).flatten()
