...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://seven-spies-admire.loca.lt", "http://localhost:5173", "https://moviemap-inky.vercel.app/main"], 
...
def recommend_similar_movies(movie_id: int, top_n: int = 10):
    ...
    if str(movie_id) in similar_cache:
        ...
        movies_ft = joblib.load("models/fasttext_tfidf_cosine.pkl")[2]
    else:
        fasttext_model, tfidf, movies_ft = joblib.load("models/fasttext_tfidf_cosine.pkl")
